...
// ─── Tool definitions ─────────────────────────────────────────────────────────
//
// TOOLS is the single source of truth for all tool names and schemas.
// TOOL_NAMES is exported so integration tests can assert that every tool
// has been exercised without maintaining a separate hardcoded list.
//
const TOOLS = [
  {
    name: 'list_projects',
...
// Exported so integration tests can assert every tool has coverage without
